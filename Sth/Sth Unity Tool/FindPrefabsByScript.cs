...
//Form : https://forum.unity.com/threads/editor-want-to-check-all-prefabs-in-a-project-for-an-attached-monobehaviour.253149/
...
public class FindPrefabsByScript : EditorWindow
{
    [MenuItem("Deadly Soap Tools/Search For Components")]
    static void Init()
    {
        FindPrefabsByScript window = (FindPrefabsByScript)EditorWindow.GetWindow(typeof(FindPrefabsByScript));
        window.Show();
